...
import type {
  GetPersonByNameRequest as _GetPersonByNameRequest,
  GetPersonByNameRequest__Output as _GetPersonByNameRequest__Output,
} from "./GetPersonByNameRequest";
...
export interface AddressBookServiceClient extends grpc.Client {
  AddPerson(
    ...
    callback: grpc.requestCallback<_Person__Output>
  ...
  GetPersonByName(
    argument: _GetPersonByNameRequest,
    metadata: grpc.Metadata,
    options: grpc.CallOptions,
    callback: grpc.requestCallback<_Person__Output>
  ): grpc.ClientUnaryCall;
...
export interface AddressBookServiceDefinition extends grpc.ServiceDefinition {
  ...
  GetPersonByName: MethodDefinition<
    _GetPersonByNameRequest,
    _Person,
    _GetPersonByNameRequest__Output,
    _Person__Output
  >;
}
